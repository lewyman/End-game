...
import { Pill, Menu, X, Moon, Sun, GraduationCap, Bot } from "lucide-react";
    ...
    <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
      <div className="container mx-auto flex h-20 items-center px-4">
        <Link to="/" className="flex items-center gap-2 font-bold text-lg">
          <span className="text-blue-600">Bio-Sync Academy</span>
        </Link>
        ...
        <nav className="hidden md:flex gap-6 text-sm ml-auto items-center">
          ...
          <Link 
            to="/nursing" 
            className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:opacity-90 font-medium flex items-center gap-2 shadow-md"
          >
