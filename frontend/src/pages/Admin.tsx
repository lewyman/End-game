...
export default function Admin() {
  ...
  if (!loggedIn) {
    return (
      <div className="min-h-screen pt-24 bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center p-4">
  ...
  return (
    <div className="min-h-screen pt-24 bg-zinc-50 dark:bg-zinc-900 p-6">
