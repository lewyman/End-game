      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="relative mb-8">
          ...
          <input
            ...
            className="w-full bg-white/50 border border-slate-700 rounded-xl pl-12 pr-4 py-3 text-white placeholder-slate-400 focus:outline-none focus:border-blue-500/50"
          />
        </div>
