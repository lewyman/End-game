    ...
    <div className="relative">
      ...
      {isSpeaking && (
        <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 flex gap-1">
          <div className="w-1 h-3 bg-[#1a5fa8]/80 rounded-full animate-bounce" style={{ animationDelay: "0ms" }} />
          <div className="w-1 h-4 bg-[#1a5fa8]/80 rounded-full animate-bounce" style={{ animationDelay: "150ms" }} />
          <div className="w-1 h-3 bg-[#1a5fa8]/80 rounded-full animate-bounce" style={{ animationDelay: "300ms" }} />
        </div>
      )}

      {/* Name tag */}
      <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-[#1a5fa8] text-white px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap">
        M.A.I.A
      </div>
    </div>
  );
